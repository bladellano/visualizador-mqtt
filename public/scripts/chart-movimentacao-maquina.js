document.addEventListener('DOMContentLoaded', function () {
    ...
    var categories = ['PAROU', 'EM MOVIMENTO'];
    var selector = 'chart-movimentacao-maquina';
    var typeEvent = 'TW92aW1lbnRhw6fDo28gTWFxdWluYQ==';
    var titleChart = 'Movimentação da Máquina';
